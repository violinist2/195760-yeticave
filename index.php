...
$items = ['2014 Rossignol District Snowboard' => ["Доски и лыжи", "10999", "img/lot-1.jpg"], 'DC Ply Mens 2016/2017 Snowboard' => ["Доски и лыжи", "159999", "img/lot-2.jpg"], 'Крепления Union Contact Pro 2015 года размер L/XL'=> ["Крепления","8000","img/lot-3.jpg"], 'Ботинки для сноуборда DC Mutiny Charocal' => ["Ботинки","10999","img/lot-4.jpg"], 'Куртка для сноуборда DC Mutiny Charocal' => ["Одежда", "7500", "img/lot-5.jpg"], 'Маска Oakley Canopy' => ["Разное","5400","img/lot-6.jpg"]];
//echo "<pre>";
//print_r($items);
//echo "</pre>";
?>
    ...
    $index = $index + 1;
        ...
        <ul class="lots__list">
         ...
         foreach  ($items as $key => $val) {
            ...
            // echo $val[0]; // вид
            // echo $val[1]; // цена
            // echo $val[2]."<br>"; // картинка
             
        //    foreach  ($val as $innerkey => $rr) {
            ?>
            <li class="lots__item lot">
               
                <div class="lot__image">
                    <img src="<?=$val[2];?>" width="350" height="260" alt="<?=$val[0];?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$val[0];?></span>
                    <h3 class="lot__title"><a class="text-link" href="#"><?=$key;?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=$val[1];?><b class="rub">р</b></span>
                        </div>
